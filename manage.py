...
from app.models import User, Role, Post, Follow, Comment, Changelog
...
def make_shell_context():
    ...
    return dict(app=app, db=db, User=User, Role=Role, Post=Post, Follow=Follow, Comment=Comment, Changelog=Changelog)
